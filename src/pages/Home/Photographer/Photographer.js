...
const Photographer = () => {
    ...
    return (
        ...
        <div className='d-flex justify-content-between align-items-center'>
            <h3>Photographers</h3>
            <button className='grapherMoreBtn' style={{  }}>View More</button>
        </div>
        ...
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 ">
            ...
            {/* {
                homeGrapher.map(offer => <SingleOffer
                    key={offer._id}
                    offer={offer}
                />)
            } */}
            ...
            {/* <div className="col d-flex justify-content-center">
                <div className="card single-card">
                    ...
                    <div className="card-body">
                        <h3 className="card-title">Araminta Arden</h3>
                        <div className="d-flex justify-content-between align-items-center">
                            <h6>per hour</h6>
                            <h4>BDT 1000</h4>
                        </div>
                        <p className="card-text">Aliquid neque esse quidem nobis nemo dolorem natus in? Porro, soluta reiciendis! Rem hic cupiditate saepe, eligendi mollitia est in quis itaque.</p>
                        <div className="text-center mt-4">
                            <Link to={`/bookingnow`}><button className="btn btn-success" style={{ marginTop:'0px' }}>Booking Now</button></Link>
                        </div>
                    </div>
